...
@section('content')
    ...
    <img src="{{ asset('imgs/elementos/fondo_Anni_invite_03.jpg') }}" class="imagemb fixed sm:w-full  md:w-full lg:h-screen	xl:h-screen 2xl:h-screen  hidden" />
    ...
    <div class="pagecontent relative sm:w-full" >
        ...
        <div class="flex w-full">
            ...
            <div class="w-1/4"><img src="{{ asset('imgs/Mobile/Recurso_mb_6_8_2.png') }}" class="divhojasmb  hidden w-full" style="float: right!important;" />
                </div>
        </div>
        <img src="{{ asset('imgs/Desktop/Recursodesck6_8.png') }}"  class="relative z-50 w-1/4 hojasbtDS" style="float: right"/>
